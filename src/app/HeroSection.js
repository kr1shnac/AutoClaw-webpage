      ...
      >
        ...
        <div
          style={{
            ...
            padding: '0.6rem 2rem',
            zIndex: 2,
            transform: phase >= 1 && phase < 3 ? 'scale(1) translateY(0)' : 'scale(0.9) translateY(15px)',
        ...
        >
          <span
            style={{
              ...
              background: phase < 2 ? '#94a3b8' : 'var(--accent-gradient)',
          ...
          >
            {phase < 2 ? 'SYSTEM ONLINE' : 'READY TO WORK.'}
          </span>
        </div>
      </div>
